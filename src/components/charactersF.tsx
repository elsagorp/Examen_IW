...
const CharactersFull: FC<CharactersProp> = ({ page,  filtsta,filtgen, status, gender, name, filtnam}) => {


  const { data, loading, error, refetch } =  useQuery<CharactersType>(GET_CHARACTERS_FILTER, { variables: {  page: page , filter: {status: status, name: name}  } });
