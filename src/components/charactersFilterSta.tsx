...
const CharactersSta: FC<CharactersProps> = ({ page, filtsta,filtgen, status, gender }) => {


const { data, loading, error, refetch } =  useQuery<CharactersType>(GET_CHARACTERS_FILTER, { variables: {  page: page , filter: {status: status} } });
